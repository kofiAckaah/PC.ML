...
namespace PC_ML_Core
{
    ...
    {
        public const string RetrainFilePath = @"C:\Users\Admin\Downloads\laptopprices.tsv";

        public static string ModelRetrainPath = Path.Combine(BaseDirectory, "laptopprices.tsv");
        ...
        {
            if(string.IsNullOrEmpty(inputDataFilePath))
            {
                inputDataFilePath = ModelRetrainPath;
            }
